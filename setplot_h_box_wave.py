...
fort_output1 = '/home/judah/hbox-examples/_output_cellwall_3_2_wet/fort.q00'
h1 = numpy.zeros((21,400))
hu1 = numpy.zeros((21,400))
hi = 0
hui = 0
for i in range(21):
...
#--------------------------
    ...
    def height2(current_data):
        ...
        axis = plt.gca()
        axis.plot(xc,h1[current_data.frameno,:]+bathy(current_data),'r:')
    ...
    plotitem.color = rgb_converter((255,255,255))
