...
def setup(kernel_language='Python',use_petsc=False, outdir='./_output3_4_wet', solver_type='classic'):
...
# get the solution q and capacity array and give out the mass
    ...
    plot(setplot="./setplot_h_box_wave.py",outdir=outdir,plotdir='./plots3_4_wet',iplot=False, htmlplot=True, **plot_kargs)
