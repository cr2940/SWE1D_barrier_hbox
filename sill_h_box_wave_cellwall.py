...
def hbox_bc(state,dim,t,qbc,auxbc,num_ghost=2):
    ...
    auxbc[1,-1] = auxbc[1,-4]
    auxbc[1,-2] = auxbc[1,-1]
def setup(kernel_language='Python',use_petsc=False, outdir='./_output_cellwall_small_wet', solver_type='classic'):
...
# get the solution q and capacity array and give out the mass
    ...
    plot(setplot="./setplot_h_box_wave.py",outdir=outdir,plotdir='./plots_actual_small_wet',iplot=False, htmlplot=True, **plot_kargs)
