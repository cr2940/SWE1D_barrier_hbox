...
def setup(kernel_language='Python',use_petsc=False, outdir='./_output3_small_inc_400', solver_type='classic'):
...
# get the solution q and capacity array and give out the mass
    ...
    plot(setplot="./setplot_h_box_wave.py",outdir=outdir,plotdir='./plots_small_300',iplot=False, htmlplot=True, **plot_kargs)
