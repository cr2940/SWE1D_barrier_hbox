...
def setup(kernel_language='Python',use_petsc=False, outdir='./_output3_small_wet', solver_type='classic'):
    ...
    state.problem_data['max_iteration'] = 5
    #state.problem_data['method'] = 'h_box_wave' # double hbox method makes this unnecessary!
    state.problem_data['zero_width'] = True
    #state.problem_data['arrival_state'] = False # double hbox method makes this unnecessary!
    ...
    # Initial Conditions
    #state.index_capa = 1 # dbl hbox method makes this unnnecessary
    ...
    # state.q[0,nw:] = 0 # uncomment for dry state on the right side of wall
...
# get the solution q and capacity array and give out the mass
    ...
    plot(setplot="./setplot_h_box_wave.py",outdir=outdir,plotdir='./plots_small_wet',iplot=False, htmlplot=True, **plot_kargs)
